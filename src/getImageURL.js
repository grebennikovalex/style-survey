...
export const getImageURL = async (prompt) => {
    const token = 'user:884-iUCErmfXOkDFdyfP2rcdy';
    const discord = 'MTEyMzM2NjIyMDkxODQzMTc3NA.G5jsZD.UWDeTWPwT5HLjDlJ4kvJ4GjeCilCiXzYZCITD8';
    const server = '1150791080753774642';
    const channel = '1215254077462814750';
                                    ...
                                    switch (btnJobResponse.status) {
                                        case 200:
                                            if (btnJobRresult.status == 'completed') {
                                                ...
                                                if (btnJobRresult.status == 'started' || btnJobRresult.status == 'progress') {
